  ...
  return knex('users').del()
    .then(function () {
      return Promise.all([
        ...
        knex('urls').insert({id: 1, title: 'foo', description: '1234', created_at: '2012-04-03'}),
        knex('urls').insert({id: 2, title: 'bar', description: '1234', created_at: '2012-04-03'}),
        knex('urls').insert({id: 3, title: 'baz', description: '1234', created_at: '2012-04-03'}),
